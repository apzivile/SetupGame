...
public class Enemy {
    ...
    Enemy(Texture enemyTexture, ShotManager shotManager) {
    ...
    private void spawn() {
        ...
        animatedSprite.setPosition(xPosition, ShooterGame.VIEWPORT_HEIGHT - animatedSprite.getHeight());
    ...
    private int createRandomPosition() {
        ...
        int randomNumber = random.nextInt(ShooterGame.VIEWPORT_WIDTH - animatedSprite.getWidth() + 1);
